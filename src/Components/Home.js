...
import cropped_image from '../images/cropped_image.png'; // Update the path if your photo is in a different directory
    ...
    <div className='container'>
      <div className='HomePage'>
        ...
        <div className="photo-container">
          <img className="my-photo" src={cropped_image} alt="My Photo" /> {/* Display your photo */}
        </div>
      </div>
